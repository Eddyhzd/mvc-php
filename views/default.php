...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <ul class="navbar-nav mr-auto">
                <li class="nav-item">
                    <a class="nav-link" href="/compteRendu">Mon compte rendu</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/calendrier">Mon calendrier</a>
                </li>
            </ul>
            <ul class="navbar-nav ml-auto">
                <?php if(isset($_SESSION['user']) && !empty($_SESSION['user']['id'])): ?>
                    ...
                    <?php endif; ?>
                    <?php if(isset($_SESSION['user']['roles']) && in_array('MANAGER', $_SESSION['user']['roles'])): ?>
                        <li class="nav-item">
