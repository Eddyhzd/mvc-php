      ...
      <div class="col card">
        <div class="card-body">
          ...
          <form method="post" action="/compteRendu/modifierTicket">
            ...
            <a class="btn btn-light" href="/compteRendu/modifierJour/<?= $jour->ID_SALARIE ?>/<?= $jour->DATE_JOUR ?>"><?= trim($jour->NOTES_JOUR) == '' ? "+ " : "<i class=\"fa fa-eye\" aria-hidden=\"true\"></i>" ?><i class="fa fa-file-text-o" aria-hidden="true"></i></a>
          </form>
        </div>
      </div>
